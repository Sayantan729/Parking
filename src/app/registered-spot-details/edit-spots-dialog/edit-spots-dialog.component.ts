...
export class EditSpotsDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<EditSpotsDialogComponent>,
    @Inject(MAT_DIALOG_DATA) private data: any,private database:DatabaseService,private dialog:MatDialog,private router:Router,private registered:RegisteredSpotService) { }
